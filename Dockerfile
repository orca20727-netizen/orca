...
COPY index.html app.js styles.css sw.js manifest.json config.js live-overrides.js ocean-bg.css transparent-cards.css react-components.js variable-weight-headings.js static/
