...
COPY index.html app.js intel.js styles.css sw.js manifest.json config.js live-overrides.js ocean-bg.css react-components.js variable-weight-headings.js tailwind-build.css static/
