...
COPY data/data/ data/
COPY index.html app.js styles.css sw.js manifest.json config.js live-overrides.js neon-border.js transparent-cards.css beyond-horizon-bg.js react-components.js static/
EXPOSE 8000
