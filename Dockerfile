...
COPY index.html app.js styles.css sw.js manifest.json config.js live-overrides.js ocean-bg.css ocean-background-v2.jpg react-components.js variable-weight-headings.js tailwind-build.css static/
